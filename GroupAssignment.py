...
def Model_cv(X_train,X_test,y_train,y_test,layer,solver,activition):
    ...
    print("layer: %d.  solver:  %s   activition:  %s" % (layer,solver,activition))
    print("rmse_train_std %.4f" %arr_rmse_train.std())
    print("rmse_train_mean %.4f" %arr_rmse_train.mean())
    print("rmse_test_std %.4f" %arr_rmse_test.std())
    print("rmse_test_mean %.4f" %arr_rmse_test.mean())
    print("score_std %.4f" %arr_score.std())
    print("score_mean %.4f" %arr_score.mean())
...
#fig=plt.figure()
#ax=fig.add_subplot(111)
#ax.plot(X_time,y_2,'b--')
#ax.scatter(X_time,y_1,c='red')
#plt.legend(['predict Y','actual Y'],ncol=1,loc=0)
...
print("rbf avg rmse:",sum(lst_rmse_rbf)/len(lst_rmse_rbf))
print("rbf std rmse:",math.sqrt(((np.array(lst_rmse_rbf) - (sum(lst_rmse_rbf)/len(lst_rmse_rbf))) ** 2).sum()))
print("linear avg rmse:",sum(lst_rmse_linear)/len(lst_rmse_linear))
print("linear std rmse:",math.sqrt(((np.array(lst_rmse_linear) - (sum(lst_rmse_linear)/len(lst_rmse_linear))) ** 2).sum()))
print("poly avg rmse:",sum(lst_rmse_poly)/len(lst_rmse_poly))
print("poly std rmse:",math.sqrt(((np.array(lst_rmse_poly) - (sum(lst_rmse_poly)/len(lst_rmse_poly))) ** 2).sum()))
